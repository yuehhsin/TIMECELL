...
const EventList = ()=>{
    ...
    const [eventText,setEventText] = useState([{content:"Learn React",color:"#DB4453",id:Math.random()}])  //建立event列表
    ...
    return (
        <>
            ...
            <div style={SP? {dispaly:"flex"}:{display:"none"}}>
                ...
                <EventForm inputValue={inputValue} setInputValue={setInputValue} eventText={eventText} setEventText={setEventText}/>
            </div>
        </>
    )
}
